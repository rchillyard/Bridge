...
class NodeSpec extends FlatSpec with Matchers {
	...
	it should "replace 1" in {
		...
		result should matchPattern {
			case MockNode(1, None, Seq(MockNode(3, None, Nil))) =>
		}
	}
	...
	it should "replace 2" in {
		...
		result should matchPattern {
			case MockNode(1, None, Seq(MockNode(2, _, Seq(MockNode(4, _, Nil))))) =>
		}
	}
	...
	it should "append 1" in {
		...
		result should matchPattern {
			case MockNode(1, None, Seq(MockNode(2, None, Seq(MockNode(3, None, Nil))))) =>
		}
	}
	...
	it should "append 2" in {
		...
		result should matchPattern {
			case MockNode(1, None, Seq(MockNode(2, None, Seq(MockNode(3, None, Seq(MockNode(4, None, Nil))))))) =>
		}
	}
